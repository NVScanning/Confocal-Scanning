...
class MotorizedStageApp(tk.Tk):
    def __init__(self):
        ...
        # X-axis move_to
        self.entry_x_to = tk.Entry(self)
        self.entry_x_to.pack()
        self.move_x_to_button = tk.Button(self, text="Move X To", command=self.move_x_to)
        self.move_x_to_button.pack()

        # Y-axis move_to
        self.entry_y_to = tk.Entry(self)
        self.entry_y_to.pack()
        self.move_y_to_button = tk.Button(self, text="Move Y To", command=self.move_y_to)
        self.move_y_to_button.pack()

        # Z-axis move_to
        self.entry_z_to = tk.Entry(self)
        self.entry_z_to.pack()
        self.move_z_to_button = tk.Button(self, text="Move Z To", command=self.move_z_to)
        self.move_z_to_button.pack()        

        # X-axis buttons        
        self.up_button = tk.Button(self, text="X Up")
        self.up_button.pack()
        self.up_button.bind("<ButtonPress>", self.move_x_up_press)
        self.up_button.bind("<ButtonRelease>", self.move_x_up_release)

        self.down_button = tk.Button(self, text="X Down")
