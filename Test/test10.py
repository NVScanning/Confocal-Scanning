...
class MotorizedStageApp(tk.Tk):
    def __init__(self):
        ...
        self.move_x_to_button = tk.Button(x_frame, text="Move X To", command=self.move_x_to)
        self.move_x_to_button.pack()

        self.up_button = tk.Button(x_frame, text="X Up")
        self.up_button.pack()
        self.up_button.bind("<ButtonPress>", self.move_x_up_press)
        self.up_button.bind("<ButtonRelease>", self.move_x_up_release)

        self.down_button = tk.Button(x_frame, text="X Down")
        ...
        self.move_y_to_button = tk.Button(y_frame, text="Move Y To", command=self.move_y_to)
        self.move_y_to_button.pack()

        self.up_button = tk.Button(y_frame, text="Y Up")
        self.up_button.pack()
        self.up_button.bind("<ButtonPress>", self.move_y_up_press)
        self.up_button.bind("<ButtonRelease>", self.move_y_up_release)

        self.down_button = tk.Button(y_frame, text="Y Down")
        self.down_button.pack()
        ...
        self.move_z_to_button = tk.Button(z_frame, text="Move Z To", command=self.move_z_to)
        self.move_z_to_button.pack()

        self.up_button = tk.Button(z_frame, text="Z Up")
        self.up_button.pack()
        self.up_button.bind("<ButtonPress>", self.move_z_up_press)
        self.up_button.bind("<ButtonRelease>", self.move_z_up_release)

        self.down_button = tk.Button(z_frame, text="Z Down")
        self.down_button.pack()
