...
class ScannerApp(tk.Tk):
    ...
    def create_control_panel(self):
        ...
        ttk.Label(scanning_control_frame, text="Total Length_X (mm)").grid(row=1, column=0, padx=5, pady=5, sticky="w")
        self.total_x_length = ttk.Entry(scanning_control_frame, width=10)
        self.total_x_length.insert(0, "0.01")
        self.total_x_length.grid(row=1, column=1, padx=5, pady=5, sticky="w")

        ttk.Label(scanning_control_frame, text="Total Length_Z (mm)").grid(row=1, column=2, padx=5, pady=5, sticky="w")
        self.total_z_length = ttk.Entry(scanning_control_frame, width=10)
        self.total_z_length.insert(0, "0.01")
        self.total_z_length.grid(row=1, column=3, padx=5, pady=5, sticky="w")

        ttk.Label(scanning_control_frame, text="Step Length_X (mm)").grid(row=2, column=0, padx=5, pady=5, sticky="w")
        self.delta_x = ttk.Entry(scanning_control_frame, width=10)
        self.delta_x.insert(0, "0.0001")
        self.delta_x.grid(row=2, column=1, padx=5, pady=5, sticky="w")

        ttk.Label(scanning_control_frame, text="Step Length_Z (mm)").grid(row=2, column=2, padx=5, pady=5, sticky="w")
        self.delta_z = ttk.Entry(scanning_control_frame, width=10)
        self.delta_z.insert(0, "0.0001")
        self.delta_z.grid(row=2, column=3, padx=5, pady=5, sticky="w")

        ttk.Label(scanning_control_frame, text="Delay_X (sec)").grid(row=3, column=0, padx=5, pady=5, sticky="w")
        self.delay_x = ttk.Entry(scanning_control_frame, width=10)
        self.delay_x.insert(0, "0.1")
        self.delay_x.grid(row=3, column=1, padx=5, pady=5, sticky="w")

        ttk.Label(scanning_control_frame, text="Delay_Z (sec)").grid(row=3, column=2, padx=5, pady=5, sticky="w")
        self.delay_z = ttk.Entry(scanning_control_frame, width=10)
        self.delay_z.insert(0, "0.1")
        self.delay_z.grid(row=3, column=3, padx=5, pady=5, sticky="w")
        ...
        self.abort_button.grid(row=5, column=2, columnspan=1, padx=10, pady=10, sticky="ew")
        ...
        self.fast_axis.grid(row=0, column=3, padx=5, pady=5, sticky="w")        
    ...
    def scan_loop(self):
        ...
        delay_x = float(self.delay_x.get())
        ...
        x_steps = int(total_x_length / delta_x)
        ...
        for i in range(z_steps):
            ...
            while self.my_app.motor_z.is_in_motion == True:
                time.sleep(0.01)
