...
class ScannerApp(tk.Tk):
    ...
    def create_control_panel(self):
        ...
        ttk.Label(scanning_control_frame, text="Total Length_X (mm)").grid(row=0, column=0, padx=5, pady=5, sticky="w")
        self.total_x_length = ttk.Entry(scanning_control_frame, width=10)
        self.total_x_length.insert(0, "0.01")
        self.total_x_length.grid(row=0, column=1, padx=5, pady=5, sticky="w")
        ...
        ttk.Label(scanning_control_frame, text="Step Length_X (mm)").grid(row=1, column=0, padx=5, pady=5, sticky="w")
        self.delta_x = ttk.Entry(scanning_control_frame, width=10)
        self.delta_x.insert(0, "0.0001")
        self.delta_x.grid(row=1, column=1, padx=5, pady=5, sticky="w")
        ...
        ttk.Label(scanning_control_frame, text="Delay_X (sec)").grid(row=2, column=0, padx=5, pady=5, sticky="w")
        self.delay_x = ttk.Entry(scanning_control_frame, width=10)
        self.delay_x.insert(0, "0.1")
        self.delay_x.grid(row=2, column=1, padx=5, pady=5, sticky="w")
