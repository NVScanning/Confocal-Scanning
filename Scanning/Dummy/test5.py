...
class ScannerApp(tk.Tk):
    ...
    def create_control_panel(self):
        ...
        self.apd_signal_label = ttk.Label(self.control_frame, text="APD Signal: N/A", font=("Helvetica", 24), foreground="#0077FF", background="black", width=15)
    ...
    def update_graph(self, data):
        ...
        heatmap_data = np.zeros((z_steps, y_steps)) * np.nan
