...
class MotorizedStageApp(tk.Tk):
    def __init__(self):
        ...
        self.up_button = tk.Button(x_frame, text="Up")
        ...
        self.down_button = tk.Button(x_frame, text="Down")
